              ...
              {error && (
                <div className="flex gap-3 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                  ...
                  <p
                    ...
                    className="text-sm text-red-700 dark:text-red-300 underline cursor-pointer font-bold"
                  >
                    {(error as any).status === 403 && "Reenviar"}
                  </p>
                </div>
              )}
                      ...
                      <div className="relative">
                        ...
                        <FormControl>
                          <Input
                            ...
                            placeholder="••••••••"
                            className="pl-10 pr-10 bg-slate-50 dark:bg-slate-700 border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400"
                            disabled={isPending}
                            {...field}
                          />
                        </FormControl>
                        <button
                          ...
                          className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-300 disabled:opacity-50"
                          aria-label={
                            showPassword
                              ? "Ocultar contraseña"
                              : "Mostrar contraseña"
