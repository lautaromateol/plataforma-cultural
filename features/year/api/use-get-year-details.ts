...
export type StudentData = NonNullable<SuccessResponse["students"]>[number];
export type TeacherData = NonNullable<SuccessResponse["teachers"]>[number];
export type CourseData = NonNullable<SuccessResponse["courses"]>[number];
export type SubjectData = NonNullable<SuccessResponse["subjects"]>[number];
