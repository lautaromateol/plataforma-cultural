...
import { useDeleteSubject } from "../api/use-delete-subject"
...
import { AlertCircle, Edit, Trash2, Plus, ArrowUpDown, Search, BookMarked } from "lucide-react"
...
export function SubjectTable({ onEdit, onCreate }: SubjectTableProps) {
  const { subjects, isPending, error } = useGetSubjects()
    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
        <div>
          ...
          <CardDescription>
            Gestiona las materias del sistema educativo
          </CardDescription>
        </div>
        ...
        {isPending ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Comienza creando la primera materia
            </p>
